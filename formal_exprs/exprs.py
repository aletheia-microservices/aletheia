...
expr2 = (
    ...
    r"$[d'_{T_{A}}(\ldots)]_{req_{2}}\ \wedge\ $"
...
expr4 = (
    ...
    r"$[\,r'_{T_{A}}(k)\ \wedge\ r'_{T_{B}}(k)\,]_{req_{2}}$"
)
...
for title, expr in exprs:
    ...
    y, _ = add_text_and_step(
        0, y, title,
        fontsize=16, va="top", ha="center", weight="medium"
    )
    y -= pad_title_expr
...
plt.tight_layout()
plt.savefig("exprs.png", dpi=200, bbox_inches="tight")
#plt.show()
