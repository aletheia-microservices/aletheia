...
[0] (StructObject UserType) student coupons_app.Student struct{StudentID int, Name string, Balance int}
     --> w-tainted: write(students_db.Student) {1}
[_1] (Reference UserType) ref <coupon coupons_app.Student struct{StudentID int, Name string, Balance int}> @ StudentService
      --> w-tainted: write(students_db.Student.Name) {1}
...
[____4] (Reference BasicType) ref <name string> @ Frontend
      --> w-tainted: write(students_db.Student.StudentID) {1}
[__2] (FieldObject FieldType) StudentID int
       --> w-tainted: write(students_db.Student.StudentID) {1}
