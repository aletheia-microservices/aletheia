[0] (PointerObject PointerType) n (*postnotification_simple.AnalyticsServiceImpl struct{analyticsQueue Queue, analyticsDb NoSQLDatabase, numWorkers int})
...
[0] (BasicObject BasicType) i 3 int
