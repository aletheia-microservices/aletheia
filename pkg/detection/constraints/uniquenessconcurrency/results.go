...
func (detector *UniquenessConcurrencyDetector) GetResults() string {
	return detector.results
}

func (detector *UniquenessConcurrencyDetector) ComputeResults(app *app.App) {
	header := "---------------------------------------------------------------------\n"
	header += "------------------- ANALYSIS: UNIQUENESS CONCURRENCY ----------------\n"
	header += "---------------------------------------------------------------------\n"
