...
[0] (BlueprintBackendObject BlueprintBackendType) analyticsDb NoSQLDatabase

[0] (BlueprintBackendObject BlueprintBackendType) analyticsQueue Queue

[0] (PointerObject PointerType) n (*postnotification_simple.AnalyticsServiceImpl struct{analyticsQueue Queue, analyticsDb NoSQLDatabase, numWorkers 4 int})
