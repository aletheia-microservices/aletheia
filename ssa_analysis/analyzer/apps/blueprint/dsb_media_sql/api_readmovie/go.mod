module github.com/blueprint-uservices/blueprint/examples/dsb_media_sql/init

go 1.22.4

require (
	github.com/blueprint-uservices/blueprint/examples/dsb_media_sql/workflow v0.0.0
