module github.com/blueprint-uservices/blueprint/examples/large_scale_app_B/init

go 1.22.4

require (
	github.com/blueprint-uservices/blueprint/examples/large_scale_app_B/workflow v0.0.0
