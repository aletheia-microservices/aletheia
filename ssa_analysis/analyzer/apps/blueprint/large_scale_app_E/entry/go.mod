module github.com/blueprint-uservices/blueprint/examples/large_scale_app_E/init

go 1.22.4

require (
	github.com/blueprint-uservices/blueprint/examples/large_scale_app_E/workflow v0.0.0
