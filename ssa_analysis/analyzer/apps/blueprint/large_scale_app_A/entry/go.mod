module github.com/blueprint-uservices/blueprint/examples/large_scale_app_A/init

go 1.22.4

require (
	github.com/blueprint-uservices/blueprint/examples/large_scale_app_A/workflow v0.0.0
