...
ALL_APPS = ['postnotification', 'postnotification_simple', 'trainticket', 'shopping_app', 'shopping_simple', 'sockshop2', 'foobar', 'app_constraints_referential_integrity', 'employee_app', 'dsb_sn', 'coupons_app', 'coupons_app_sql', 'digota']
ALL_GRAPHS = ['app', 'call']
